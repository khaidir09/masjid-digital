...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-slate-50">
    ...
    <head>
        ...
        {{-- JANGAN IMPORT ALPINE JS DI SINI, LIVEWIRE SUDAH BAWA OTOMATIS --}}
    ...
    <body class="h-full overflow-hidden text-slate-900 work-sans-all bg-slate-50">
        ...
        {{-- Gunakan x-data tanpa tanda titik dua di atribut komponen blade --}}
        <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false, confirmLogout: false }">
            ...
            <div class="flex flex-col flex-1 min-w-0 overflow-hidden relative">
                <header
                    class="relative z-10 flex-shrink-0 h-20 flex items-center justify-between px-8 bg-white/50 backdrop-blur-md">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="hidden md:flex flex-col items-end mr-4" x-data="{ time: '' }"
                        ...
                        <div
                            class="w-10 h-10 rounded-2xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-emerald-500 font-black text-sm uppercase">
                            {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                        </div>
                    </div>
                </header>

                <main class="flex-1 relative z-10 overflow-y-auto custom-scrollbar-dark p-6 md:p-8">
            ...
            <div x-show="confirmLogout" class="fixed inset-0 z-[99999] flex items-center justify-center p-4"
                ...
                <div class="bg-white rounded-[3rem] p-10 w-full max-w-sm text-center shadow-2xl relative z-10 border border-slate-100"
                    ...
                    <p class="text-slate-500 font-medium text-xs mb-8 leading-relaxed">Sesi Anda akan diakhiri. Pastikan
                        semua perubahan data telah disimpan.</p>
