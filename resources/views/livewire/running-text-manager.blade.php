    <div class="space-y-8 md:space-y-8 pb-20 work-sans-all">
        ...
        <div class="bg-white rounded-[3.5rem] border border-slate-100 shadow-xl overflow-hidden min-h-125 relative">
            <div class="px-6 py-6 md:px-12 md:py-10 flex flex-col md:flex-row justify-between items-center bg-slate-50/50 gap-6 border-b border-slate-50">
            ...
            @if (session()->has('message'))
                <div class="bg-emerald-500 text-white px-6 py-4 md:px-10 font-black text-xs uppercase tracking-widest text-center animate-pulse">
                    {{ session('message') }}
                </div>
            @endif
            ...
            <div class="px-6 pb-6 md:px-10 md:pb-10">{{ $data->links() }}</div>
        </div>
        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center bg-slate-900/90 backdrop-blur-sm p-4 animate-fade-in">
            <div class="bg-white rounded-[2.5rem] p-6 md:p-10 w-full max-w-lg shadow-2xl relative overflow-hidden">
        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center bg-rose-900/90 backdrop-blur-sm p-4 animate-fade-in">
            <div class="bg-white rounded-[2.5rem] p-6 md:p-10 w-full max-w-md text-center shadow-2xl relative overflow-hidden">
