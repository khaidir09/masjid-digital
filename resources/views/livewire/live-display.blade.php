<div x-data="displaySystem()" x-init="initSystem()"
    ...
    <div class="flex-1 flex flex-col min-h-0 rounded-[2vh] border-4 transition-colors duration-500 overflow-hidden"
        :class="themeMode === 'light' ? 'border-slate-300 shadow-xl' : 'border-white/20 shadow-2xl'">
        ...
        @foreach ($waktuSholat as $index => $waktu)
            ...
            <div class="flex-1 flex justify-between items-center px-[2vw] transition-all duration-500 relative {{ $borderClass }}"
                :class="[
